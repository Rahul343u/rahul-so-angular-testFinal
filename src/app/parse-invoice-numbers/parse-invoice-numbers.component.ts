...
@Component({
  selector: 'app-parse-invoice-numbers',
  templateUrl: './parse-invoice-numbers.component.html',
  styleUrls: ['./parse-invoice-numbers.component.css']
})
export class ParseInvoiceNumbersComponent implements OnInit {
  data;
  dataToParse;
  res;
  ...
  get7segment() {
    ...
    for (var line = 0; line < lines.length; line = line + 2) {
      var arr = [[], [], [], [], [], [], [], [], []]; // Defining 2D array 9 numbers and 7 segments
      var k = 0;
